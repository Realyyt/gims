...
export default function IndustrialApplicationsCarousel({
  ...
  return (
    <section id="applications" className="py-20 bg-[#293241]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.h2 
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="text-4xl font-bold text-center mb-4 text-[#e0fbfc]"
        >
        ...
        <motion.p 
          ...
          className="text-[#98c1d9] text-center mb-16 max-w-2xl mx-auto"
        >
                  ...
                  <div className="relative h-full w-full group">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-end p-8 md:p-12">
                      <div className={`transform transition-all duration-700 delay-100
                        ...
                        <h3 className="text-3xl md:text-4xl font-bold text-[#e0fbfc] mb-4">
                          {app.title}
                        </h3>
                        <p className="text-lg text-[#98c1d9] mb-6 max-w-2xl">
                          {app.description}
                        </p>
                        <div className="flex gap-4">
                          <button className="bg-[#3d5a80] hover:bg-[#ee6c4d] 
                            text-[#e0fbfc] px-6 py-2 rounded-full transition-all duration-300 transform hover:scale-105">
                            Learn More
                          </button>
                          <button className="bg-[#98c1d9]/20 hover:bg-[#98c1d9]/30 text-[#e0fbfc] px-6 py-2 rounded-full 
